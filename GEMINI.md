...
Example: `{ "workspacePath": "/Users/ramadhani.musthofa/Work/nextrouter" }`
...
```bash
npx tsx /Users/ramadhani.musthofa/Work/nextrouter/src/cli/index.ts status         # Show detected providers and active sessions
npx tsx /Users/ramadhani.musthofa/Work/nextrouter/src/cli/index.ts sync           # Sync GEMINI.md, CLAUDE.md, .cursorrules
npx tsx /Users/ramadhani.musthofa/Work/nextrouter/src/cli/index.ts handover antigravity claude-code  # Generate handover packet
npx tsx /Users/ramadhani.musthofa/Work/nextrouter/src/cli/index.ts tokens         # Show token usage vs context window limits
npx tsx /Users/ramadhani.musthofa/Work/nextrouter/src/cli/index.ts prune src/adapters/antigravity.ts  # Prune a file
```
<!-- NEXTROUTER_COMMANDS_END -->

<!-- NEXTROUTER_SKILLS_START -->
## 🧩 NextRouter Auto-Injected Skills
### Skill: NextRouter MCP Shared Context Auto-Handoff (v1.1)
